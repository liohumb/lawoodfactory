        ...
        if ($order->getState() == 0) {
            ...
            $mail->send(
                ...
                "Bien le bonjour " . $user->getFirstname() . ",<br><br>
                        ...
                        Retrouvez l'avancement de votre commande <a href='https://lawoodfactory.fr/votre-compte/" . $user->getId() . "/commandes/" . $order->getReference() ."' style='color: gray'>dans votre compte L&A WoodFactory</a>."
            );
            ...
            $mailAdmin->send(
                ...
                "Bonne nouvelle Patron ! <br><br>
                        ...
                        Tout les détails sont dans <a href='https://lawoodfactory.fr/administration/commandes/" . $order->getReference() . "' style='color: gray'>votre administration</a>. <br><br>
